  ...
  return (
        ...
        <Container fluid>
            ...
            <Nav
                ...
                navbarScroll
            >
                <Link to="/" className="nav-item" href="#action1">Home</Link>
                <Link to="/movies" className="nav-item" href="#action2">Movies</Link>
